...
%% will trimble's arg
%% Preprocessing RNA scaffolding, top hat gene models, error corr
...
\begin{figure}
\centerline{\includegraphics[width=3in]{diginorm-coverage2-raw.pdf}}
\centerline{\includegraphics[width=3in]{diginorm-coverage2-dn.pdf}}
\caption{
