...
need only be performed once, prior to any assemblies.
...
used widely in image processing and video compression.  This approach has very broad applicability.  For example,
