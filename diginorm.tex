...
systematizes coverage from deep shotgun sequencing, thereby decreasing
sampling variation as well as discarding redundant data and removing
errors. Digital normalization substantially
reduces the size of data sets and decreases the memory and time
